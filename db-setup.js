    ...
    try {
        ...
        if (parseInt(resPub.rows[0].count) === 0) {
            await pool.query(`
                ...
                ('Sistema de Proteção Coordenado para Microrredes com Geração Distribuída e Armazenamento', 'Conferência', 'Publicado', 'IEEE PES ISGT Latin America', 'P018 — Microrredes Urbanas', 'Sim', 2024),
        ...
        if (parseInt(resAcad.rows[0].count) === 0) {
            await pool.query(`
                ...
                ('Simulação de Microrredes com Integração de Veículos Elétricos e Geração Distribuída', '', 'Monografia', 'Pedro Henrique Costa', 'Prof. Me. Paulo Rocha', 'P018 — Microrredes Urbanas', 2023),
